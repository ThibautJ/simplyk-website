...
<script type="text/javascript">
  var orga = document.getElementById("citoyen-button-description");
  orga.addEventListener('click', function(){
    var form = document.getElementById("description-list");
    form.innerHTML= '<div class="row"><div class="col-sm-3 text-sk block-text"><i class="icon icon-sk icon-hand-o-up"></i><b>Missions catégorisées</b> La catégorisation de nos missions te permet de choisir une activité selon que tu ais envie de faire du social, du sport ou de l\'évènmentiel par exemple.</div><div class="col-sm-3 text-sk block-text"><i class="icon icon-sk icon-map-o"></i><b>Carte interactive</b> Grâce à notre carte interactive et à notre système de mission géolocalisée, trouve une mission près de chez toi ou n\'importe où tu le désires.</div><div class="col-sm-3 text-sk block-text"><i class="icon icon-sk icon-users"></i><b>Invite tes amis</b> Si tu ne te sens pas de venir seul, franchis le pas en venant avec des amis à toi et trouve des missions pour plusieurs. </div><div class="col-sm-3 text-sk block-text"><i class="icon icon-sk icon-calendar-check-o"></i><b>Filtre temporel</b> Trouve une mission quand tu le désires, en prévoyance ou pour le dernier moment grâce à notre filtre temporel de recherche de missions. </div></div>'}, false);
</script>
